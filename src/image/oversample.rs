...
use image::{RgbImage, ImageFormat, ImageResult};
use rug::{Complex, Float, rand};
use std::cmp;
use super::FractalType;

pub fn draw_image_oversampled(path: &str, properties: WindowProperties, _fractal: FractalType, sample_rate: u32) -> ImageResult<()> {
